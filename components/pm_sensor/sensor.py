...
pm_sensor_ns = cg.esphome_ns.namespace('pm_sensor')
PMSENSORComponent = pm_sensor_ns.class_('PMSENSORComponent', uart.UARTDevice, cg.Component)
...
CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(PMSENSORComponent),

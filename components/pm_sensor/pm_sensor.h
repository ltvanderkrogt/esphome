#pragma once
// based on: https://github.com/ssieb/esphome_components/tree/master/components/sen0177 
...
class PMSENSORComponent : public Component, public uart::UARTDevice {
 public:
  PMSENSORComponent() = default;

...
void PMSENSORComponent::dump_config() {
  ESP_LOGCONFIG(TAG, "PMSENSOR:");
...
bool PMSENSORComponent::check_data_() const {
...
void PMSENSORComponent::parse_data_() {
...
uint16_t PMSENSORComponent::get_16_bit_uint_(uint8_t start_index) const {
